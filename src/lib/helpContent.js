...
export const GLOSSARY = [
  ...
  },
  {
    ...
    terms: [
      ...
      { term: "FTO / Cadets tab", def: "In the Roster Controller (Manage): hire applicants straight into your cadet rank (auto hire date, callsign, Active status), see everyone in the program, and process final evals, pass promotes them with callsign and optional probation in one click, fail terminates them to the archive. Grant Extension sets or extends a cadet's training deadline (writes to a Cadet / Recruit Deadline date column, created automatically if you don't have one yet)." },
