...
export const CAPABILITIES = [
  ...
  },
  {
    ...
    desc: "Add entries to administrative log pages (admin log, FTO, interview, booth). They can edit/delete their own entries; editing/deleting anyone's is reserved for the Management group.",
  },
  {
...
// Moderating admin logs (edit/delete ANY entry, manage logbooks) is hardcoded
// to the Management group — not a configurable capability — so no other group
